...
function upload() {
  ...
  var image = new SimpleImage(fileinput.files[0]);
  //Get canvas
...
// _______________________________
//Cover Photo Changer
function coverphotochanger_bridge() {  document.getElementById("coverPicture").src = "https://live.staticflickr.com/7291/11111496415_1cf18d1170.jpg";
...
function coverphotochanger_city() {  document.getElementById("coverPicture").src = "https://live.staticflickr.com/65535/49375360081_1d9a6bc21a.jpg"; 
                                    
  saveEl.className = "save-btn";
  document.getElementById("save-btn").innerHTML = "SAVE";
}

function coverphotochanger_logs() {  document.getElementById("coverPicture").src = "https://live.staticflickr.com/3826/10653925834_f85c32e8b2.jpg";  
                                    
  saveEl.className = "save-btn";
  document.getElementById("save-btn").innerHTML = "SAVE";
}

function coverphotochanger_plant() {  document.getElementById("coverPicture").src = "https://live.staticflickr.com/65535/49375360241_2f97122d3a.jpg";  
                                     
  saveEl.className = "save-btn";
  document.getElementById("save-btn").innerHTML = "SAVE";
}

function coverphotochanger_wall() {  document.getElementById("coverPicture").src = "https://live.staticflickr.com/3702/11639642236_c3465e1a9d.jpg";   
                                    
  saveEl.className = "save-btn";
  document.getElementById("save-btn").innerHTML = "SAVE";
}

function coverphotochanger_shoreline() {  document.getElementById("coverPicture").src = "https://live.staticflickr.com/65535/49375564862_3f94621547.jpg";  
