...
from reservation.base_models.residence import ResidenceStatus
from reservation.base_models.room import RoomStatus
...
class HotelAddressSerializer(serializers.ModelSerializer):
    class Meta:
        model = HotelAddress
        fields = ('id', 'phone', 'country', 'city', 'address')
...
class HotelRoomSerializer(serializers.ModelSerializer):
    class Meta:
        model = HotelRoom
        fields = ('id', 'number', 'capacity', 'status', 'description', 'price', 'hotel', 'room_avatar')
